...
const navItems = ["Schools", "Usage", "Logs", "Billing", "Security"];
...
export function PlatformShell({
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ ...typography.h3 }}>Platform Control</div>
          ...
          {navItems.map((item) => (
            <div
              ...
              style={{
                ...
                borderRadius: 8,
                background: item === "Schools" ? "rgba(255,255,255,0.12)" : "transparent"
              }}
            >
              {item}
            </div>
