        ...
        {loading ? (
          ...
          <>
            <div className="flex items-center justify-between bg-white px-5 py-4 rounded-2xl border border-slate-100 shadow-sm">
              ...
              <Button variant="ghost" onClick={() => router.push("/admin/classes")} className="h-9 px-4 rounded-lg border border-slate-200 text-[10px] font-bold uppercase tracking-wider hover:bg-slate-50">
