...
const stats = [
  { title: "Scheduled Exams", value: "0", detail: "Upcoming sessions", icon: "quiz", tone: "text-sky-700" },
  { title: "Today", value: "0", detail: "Live exams", icon: "today", tone: "text-emerald-700" },
  { title: "Candidates", value: "0", detail: "Registered students", icon: "groups", tone: "text-violet-700" },
];
                ...
                <div key={index} className="rounded-3xl border border-slate-200 p-4 shadow-sm">
                  <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                      ...
                      <p className="text-sm text-slate-500">Create a live exam to see it here.</p>
                    </div>
          ...
          <div className="space-y-6">
            <div className="rounded-[2rem] border border-slate-200/70 bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 space-y-3">
                {[
                  ["Create Exam", "/teacher/exams/create", "add_circle"],
                  ["Live Exam Monitor", "/teacher/live-exam", "monitor"],
