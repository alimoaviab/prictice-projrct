...
interface EmptyStateAction {
    ...
    onClick?: () => void;
    href?: string;
    /** Override the leading icon. Defaults to `add`. */
    icon?: string;
}
...
interface EmptyStateProps {
    title: string;
    description: string;
    /** Optional secondary hint shown below the description, e.g. how to change filters. */
    hint?: string;
    action?: EmptyStateAction;
    /** Optional secondary action (rendered as ghost button). */
    secondaryAction?: EmptyStateAction;
    /** Material-symbols icon name OR a fully custom ReactNode. */
