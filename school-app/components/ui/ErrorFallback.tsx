...
interface ErrorFallbackProps {
    title?: string;
    message?: string;
    /** Hint shown below the message in muted text. */
    hint?: string;
    /** Primary handler — typically a soft retry that re-runs the failed action. */
    onRetry?: () => void;
    /** Optional secondary handler. Defaults to a Reload Page action when not provided. */
    onSecondary?: () => void;
    secondaryLabel?: string;
    fullScreen?: boolean;
    /** Tone variant. Defaults to error. */
    tone?: "error" | "warning";
}
