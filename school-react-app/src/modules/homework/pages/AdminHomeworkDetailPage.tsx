...
import { ChevronLeft, FileText, Calendar, User, BookOpen, Users } from "@/components/icons";
...
export function AdminHomeworkDetailPage({ homeworkId }: { homeworkId: string }) {
    ...
    <div className="space-y-6 pb-20">
      ...
      <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm">
        <div className="flex items-center gap-4">
          <Link to="/admin/homework" className="h-10 w-10 rounded-xl bg-slate-50 flex items-center justify-center text-slate-400 hover:bg-slate-100 transition-all">
        ...
        <div className="space-y-6">
          ...
          {submissions.length > 0 && (
            <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm space-y-4">
              ...
              <button
                onClick={() => navigate(`/admin/homework/${homeworkId}/review`)}
