              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 mt-1.5 font-medium">
                    Configure test parameters and assessment settings.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5">
              <section>
                ...
                <p className="text-[11px] leading-relaxed text-slate-600 font-medium">
                  Tests are structured assessments that evaluate student learning across subjects and classes with defined scoring parameters.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="rounded-lg border border-amber-100 bg-amber-50/50 p-2.5">
                  <p className="text-[10px] leading-snug text-amber-800 font-bold">
                    Tests progress from Scheduled → Published → Results Published → Completed.
                  </p>
                </div>
              </section>
